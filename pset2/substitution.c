...
/*sivahir/substitution.c
@sivahir
sivahir automated commit by check50 [check50=True]
History
1 contributor
93 lines (91 sloc) 2.3 KB */
#include<cs50.h>
#include<stdio.h>
#include<string.h>
#include<ctype.h>
...
{
    if (argc == 2) // counts number of argument 
    {
        string key = argv[1];
        if (validate(key) == true) //Check validity (boolean)
        {
